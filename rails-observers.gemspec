...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'activemodel', '>= 5.0', '< 5.1'

  s.add_development_dependency 'minitest',     '>= 3'
  s.add_development_dependency 'railties',     '>= 5.0', '< 5.1'
  s.add_development_dependency 'activerecord', '>= 5.0', '< 5.1'
  s.add_development_dependency 'actionmailer', '>= 5.0', '< 5.1'
  s.add_development_dependency 'actionpack',   '>= 5.0', '< 5.1'
  s.add_development_dependency 'activeresource', '>= 5.0', '< 5.1'
